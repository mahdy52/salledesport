...
function gymnaz_info_page() {
  ...
  <div class="wrap about-wrap one-pageily-add-css">
    ...
    <div class="one-pageily-button-container">
      <a target="blank" href="<?php echo esc_url('https://testerwp.com/gymnaz-premium/', 'gymnaz'); ?>" class="button button-primary">
        <?php echo __("Read Full Description", "gymnaz"); ?>
      </a>
      <a target="blank" href="<?php echo esc_url('https://testerwp.com/wp/', 'gymnaz'); ?>" class="button button-primary">
